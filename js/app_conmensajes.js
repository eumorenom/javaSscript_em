  ...
  operacion: function(){
    switch (vg_operacion){
      ...
      case  "multiplicacion":{
        ...
        if (vg_n2 == 0){
           vg_n2 = 1;}
       // console.log ("enttra a  multiplicar vg_n2" + vg_n2  );

        vg_acum = parseFloat (vg_acum ) * parseFloat(vg_n2);
        //console.log ("enttra a  multiplicar vg_acum" + vg_acum  );
        break;
...
analizaoperacion: function(){
  console.log ("--- entra a nalizar operacoin");
    ...
    if (vg_acum == 0){
      ...
      vg_op1 = vg_operacion;
      vg_tecla = " ";
      console.log ("acumulado cuanto acumulado es 0 =" +  vg_acum );
      console.log ("operacion cuando acumulado es 0" +  vg_op1);
      ...
      if (vg_tecla == " ")
            {
                ...
                vg_op1 = vg_operacion;
                //console.log ("acumulado cuanto tecla es espacio =" +  vg_acum );
                console.log ("operacion cuando  tecla es espacio =" +  vg_op1);
                ...
                //logica que permite  llamar al metodo de ejecucion de la operacion
                    ...
                    vg_tecla = " ";
                    document.getElementById('display').textContent = vg_tecla;
                    //console.log ("acumulado =" + vg_acum);
                    //console.log ("operacion= "+ vg_operacion);
                    //console.log ("valor2 =" + vg_n2);
                    calculadora.operacion();

                    //console.log("valor parcial=" + vg_acum);
                    var vl_sacum = vg_acum.toString();
                    //console.log("valor parcial=antes de contrlar longitud" + vl_sacum);
                  }
    //mANEJO DEL punto decimal
    console.log ("analiza operacion: entra a anlizar decimal");
    var  vl_pos_signo = 0;
    // vl_pos_signo = vg_acum.indexOf("-");
    vg_acum = vg_acum * 1.0;
    vl_tipo=" ";
    vl_tipo = typeof vg_acum;
    console.log ("tipo "+vl_tipo);
    ...
    if (vl_pos > -1) {
                                        ...
                                        //console.log ("**** hay unpunto decimal en " + vl_pos);
                                        ...
                                        //console.log ("acumulñado es "+ vl_acum);
                                        //console.log ("longitud de variable  acumulado es "+ vg_lcadena);
                                        //console.log ("los decimales son  "+ vl_decimal);
                                        //console.log ("longitud de la variable decimales "+  vl_nroDec);
                                        for(vl_i1=1; vl_i1 <= vl_nroDec; vl_i1++ ){
                                          vl_letra =  vl_decimal.charAt(vl_i);
                                          if (vl_letra == "0" || vl_letra == "." ){
                                              vg_lcadena = vl_acum.length;
                                              //console.log( "longitud de acum " +vg_lcadena );
                                              //console.log( "valor de vl_i" + vl_i );
                                              vl_acum = vl_acum.slice(0, vg_lcadena - 1);
                                              //console.log( "Ahora contador tiene valor [" + vl_i + "]" );
                                              //console.log ("dentro del ciclo acumulado es "+ vl_acum);


                                            }
                                            else {
                                              //console.log( "encontro una letra diferente de . o 0:::"+vl_letra);
                                              break;
                                            }
                                             vl_i = vl_i - 1;
                                        }
    ...
    console.log("analizaoeracion: entrando a nalizar signo");
    var vl_pos = vl_acum. lastIndexOf("-");
    ...
    if (vl_pos > -1 ) {
                      ...
                      vg_lcadena = vl_acum.length;
                      //console.log ("strin negativo: valor del string:"+vl_acum);
    }

    if (vg_lcadena > vl_lon) {
                                          vg_lcadena = parseInt (vg_lcadena) - parseInt(vl_lon);
                                          vl_acum = vl_acum. slice(vg_lcadena);
                                          //console.log("vl_acum cuando lcadena es > 8" + vl_acum);
                                          //console.log ("variable sin  truncar "+ vg_acum);
                                          //console.log ("variable truncada "+ vl_acum);
  ...
  vg_acum = vl_acum;
  console.log ("variable acumulada a mostrar "+ vg_acum);
  console.log ("variable vg_tecla:::: "+ vg_tecla);
  vg_op1 = vg_op2;
  vg_n2   = 0;
  vg_tecla = " ";
  vg_contador = 0;
...
analizaCadena: function(){
  ...
  console.log("vg_tecla viene con= "+vg_tecla);
  ...
  //console.log("vg_lcadena= "+vg_lcadena);
...
// lineas  21-33
if  (vg_vector[0] == 0 ){
      //console.log("la primera posicion es 0 accion" );
      var  vl_tecla = vg_tecla;
      vg_tecla = vl_tecla.slice(1);
      //console.log("vg_tecla ahora queda con= "+vg_tecla);
...
if  (vg_vector[0] == "."){
      vg_tecla = "0" + vg_tecla;
      //console.log("punbto vg_tecla ahora queda con= "+vg_tecla);
}
...
if (vl_punto_si > vg_punto_si ) {
  ...
  console.log("cuando hay doble . vg_tecla= " + vg_tecla);
  vg_lcadena = vg_tecla.length;
...
vl_tecla = vg_tecla.slice(0,1);
    //console.log("signo valor de vl_tecla " + vl_tecla);
    //console.log("signo valor ultimop caracter " + vl_ultimoC);


if (vl_pos_signo > -1){
    //console.log("entrando signo  > -1" );
     if (vl_tecla == "-" && vl_ultimoC == "-" ){
          //console.log("entrando signo por igualdad" );
            vg_lcadena = vg_tecla.length;
    ...
    //console.log("signo valor de vg_tecla " + vg_tecla);


    //console.log("valor de vg_tecla en signo" + vg_tecla);
}

    // logica para q la calculadora no soporte sino hasta 8 caracteres.
if  (vg_lcadena > 8)
    {
      //console.log("se sobrepasom la capacidad de la calculadora"+ vg_lcadena);
      vg_tecla = vg_tecla.slice(0,vg_lcadena - 1);
      //console.log("valor de vg_tecla " + vg_tecla);
      vg_lcadena = vg_tecla.length;
  }


var  vl_ultimoC = vg_tecla.charAt(vl_pos_signo);
    //console.log("UltimoCaracter " +  vl_ultimoC);
...
obtenertecla: function() {
 ...
 document.getElementById('1').addEventListener("click", function(){
  ...
  // //console.log("valor tecla"+ vg_tecla);
